...
git remote add origin https://github.com/jpflori/pympfrcx.git >> install.log
...
git clone --single-branch --depth 1 https://github.com/jpflori/pympfrcx.git gh-pages >> install.log
cd gh-pages
