# -*- coding: utf-8 -*-
#
# pympfrcx documentation build configuration file,
...
project = u"A python wrapper for MPFRCX"
copyright = u"2017, Jean-Pierre Flori"
package_name = "pympfrcx"
package_folder = "../../pympfrcx"
